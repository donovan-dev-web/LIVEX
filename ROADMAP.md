...
| **U8** — Tests & persistance (V0.1 → V1) | ph7 (`SYNE-070…073`) + ph11 (`SYNE-110…113`) + `SYNE-120…122` + `SYNE-130…131` | ph8 (`ECHOS-080…085`) + ph9 (`ECHOS-090…092`) | Jalon U8 — en cours (SYNE-110→113 + 070 livrés) | Environnement (ressources/obstacles/territoire, 070-073) : **070 livré** (minéraux + cycle régénération/dégradation, engineVersion 0.7.0) — 071/072/073 restants ; SQLite bit-à-bit + reprise (110-112) + contrôle HTTP :5181 (113) — **livrés** (3 PR, 342 tests, interop `ControlClient` ECHOS OK) ; calibration/tests/cross-cutting (120-122, 130-131) ; ECHOS : 080-085 livrés (UI, U7), 085 finalisé contre le réel :5181, suite de tests 090-092 + intégration SYNE↔ECHOS↔PRISM |
