...
| **U8** — Tests & persistance (V0.1 → V1) | ph7 (`SYNE-070…073`) + ph11 (`SYNE-110…113`) + `SYNE-120…122` + `SYNE-130…131` | ph8 (`ECHOS-080…085`) + ph9 (`ECHOS-090…092`) | Jalon U8 — en cours (PR1 cadrage docs) | Environnement (ressources/obstacles/territoire, 070-073) ; SQLite bit-à-bit + reprise (110-112) + contrôle HTTP :5181 (113) ; calibration/tests/cross-cutting (120-122, 130-131) ; ECHOS : 080-085 livrés (UI, U7), 085 à finaliser contre le réel :5181, suite de tests 090-092 + intégration SYNE↔ECHOS↔PRISM |
