...
| Tests | **389 tests (369 Core + 20 Console), 94,01 % de couverture** (≥ 80 % requis, SYNE-100) ; jalons T0–T5 activés (SYNE-122) | `dotnet test --collect:"XPlat Code Coverage"` |
