...
| ID | Titre | Labels | Prio | Dépend de | Critère d'acceptation |
| :-- | :-- | :-- | :-- | :-- | :-- |
| ECHOS-020 | Moteur 1 — CognitiveDiversityMetrics (diversité cognitive) | `type/feature`, `component/echos` | P0 | ECHOS-011, `METRICS_SPEC.md` §2 | 8 métriques (§2) calculées → croyances/objectifs/intentions |
| ECHOS-021 | Moteur 2 — InformationPropagationMetrics (propagation) | `type/feature`, `component/echos` | P0 | ECHOS-011, `METRICS_SPEC.md` §3 | 5 métriques : volume, diffusion, dégradation, sauts, centralité |
| ECHOS-022 | Moteur 3 — SocialComplexityMetrics (complexité sociale) | `type/feature`, `component/echos` | P0 | ECHOS-011, `METRICS_SPEC.md` §4 | 7 métriques : confiance, variance, densité, clustering, centralité, communautés |
| ECHOS-023 | Moteur 4 — GoalConvergenceMetrics (convergence objectifs) | `type/feature`, `component/echos` | P1 | ECHOS-011, `METRICS_SPEC.md` §5 | Alignement/divergence des objectifs ; entropie de distribution |
| ECHOS-024 | Moteur 5 — FeedbackLoopDetector (boucles de rétroaction) | `type/feature`, `component/echos` | P1 | ECHOS-011, `METRICS_SPEC.md` §6 | Cycles action→conséquence→décision détectés (fenêtre 100 ticks + fréquence > 2) |
| ECHOS-025 | Moteur 6 — ResourceSustainabilityMetrics (durabilité ressources) | `type/feature`, `component/echos` | P2 | ECHOS-011, `METRICS_SPEC.md` §7 | Surexploitation / épuisement / régénération mesurés |
| ECHOS-026 | Moteur 7 — GroupDynamicsMetrics (dynamique de groupes) | `type/feature`, `component/echos` | P2 | ECHOS-011, `METRICS_SPEC.md` §8 | Formation/dissolution de groupes ; stabilité des coalitions |
| ECHOS-027 | Golden files des 7 moteurs (jalon J2) | `type/test`, `component/echos` | P0 | ECHOS-020→026, `METRICS_SPEC.md` | Scores bit-à-bit identiques entre runs à seed égale ; golden files 18+ tests |
