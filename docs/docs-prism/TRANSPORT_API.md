...
En **V0.1**, cette interface est **intégrée à ECHOS** (Electron + React) et sert aussi de complément d'affichage pour PRISM (liste des interfaces TypeScript : ses composants — voir `UX_INTERACTION.md`).
